        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar">
            <div class="position-sticky pt-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="amortization.php">
                            <i class="bi bi-house me-2"></i>Amortization
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="hoa-dues.php">
                            <i class="bi bi-cash me-2"></i>HOA Dues
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="garbage-collection.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="homeowner-approvals.php">
